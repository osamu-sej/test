COMPANIES = [
    ...
    },
    {
        ...
        "url": "https://www.lawson.co.jp/company/news/", # 【修正】releaseディレクトリを削除
        "scraper_type": "auto",
        "badge_color": "#0068B7",
        "date_format": "%Y.%m.%d"
    },
    ...
    # --- スーパー ---
    {
        ...
        "url": "https://www.aeon.info/news/", # 【修正】releaseディレクトリを削除
        "scraper_type": "auto",
        "badge_color": "#AE0E36",
        "date_format": "%Y.%m.%d"
    },
    {
        ...
        "url": "https://www.itoyokado.co.jp/company/newsrelease.html", # 【修正】news/ディレクトリではなくHTMLファイルへ
        "scraper_type": "auto",
        "badge_color": "#D70035",
        "date_format": "%Y.%m.%d"
    },
    {
        ...
        "url": "https://www.lifecorp.jp/company/info/news/", # 【修正】正しいHTTPSのURLに変更
        "scraper_type": "auto",
        "badge_color": "#F7931E",
        "date_format": "%Y.%m.%d"
    },
    ...
    },
    {
        ...
        "url": "https://www.tsuruha.co.jp/news/news/", # 【修正】HDではなく事業会社サイトへ変更
        "scraper_type": "auto",
        "badge_color": "#E60012",
        "date_format": "%Y年%m月%d日"
    },
    ...
    },
    {
        ...
        "url": "https://www.e-dkt.co.jp/ir/", # 【修正】ニュース一覧があるIRページへ変更
        "scraper_type": "auto",
        "badge_color": "#FF00FF",
        "date_format": "%Y.%m.%d"
    },
    ...
    },
    {
        ...
        "url": "https://www.calbee.co.jp/news/", # 【修正】newsreleaseからnewsへ
        "scraper_type": "auto",
        "badge_color": "#DA291C",
        "date_format": "%Y年%m月%d日"
    },
    ...
    },
    {
        ...
        "url": "https://www.fujiya-peko.co.jp/company/news/", # 【修正】URL構造変更
        "scraper_type": "auto",
        "badge_color": "#006400",
        "date_format": "%Y.%m.%d"
    },  
